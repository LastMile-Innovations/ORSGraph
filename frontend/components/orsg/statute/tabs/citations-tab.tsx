    ...
    <div className="grid grid-cols-1 gap-px bg-border lg:grid-cols-2">
      ...
      <section className="bg-card">
        ...
        {data.outbound_citations.length === 0 ? (
          <EmptyCitationColumn label="No outbound citation edges for this statute." />
        ) : (
      ...
      <section className="bg-card">
        ...
        {data.inbound_citations.length === 0 ? (
          <EmptyCitationColumn label="No inbound citation edges for this statute." />
        ) : (
          <ul className="divide-y divide-border">
...
function EmptyCitationColumn({ label }: { label: string }) {
  return (
