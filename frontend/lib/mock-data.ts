...
export const mockGraphInsights: GraphInsightCard[] = [
  {
    ...
    value: "ORS 90.100",
    subtitle: "Definition hub",
    href: "/statutes/ORS%2090.100",
    state: "ok",
  },
  {
    title: "Chapter 90",
    value: "High semantic density",
    subtitle: "obligations · deadlines · notices · remedies",
    href: "/statutes/90",
    state: "ok",
  }
]
...
export const mockFeaturedStatutes: FeaturedStatute[] = [
  {
    citation: "ORS 90.300",
    title: "Security deposits; prepaid rent",
    chapter: "Chapter 90",
    href: "/statutes/ORS%2090.300",
    status: "active",
    semanticTypes: ["obligation", "deadline", "remedy"],
    citedByCount: 15,
    sourceBacked: true,
  },
  {
  ...
  },
  {
    ...
    title: "Definitions for ORS 320.005 to 320.150",
    chapter: "Chapter 320",
    href: "/statutes/ORS%20320.005",
    status: "active",
    semanticTypes: ["definition"],
    sourceBacked: true,
  },
  {
    citation: "ORS 838.005",
    title: "Definitions",
    chapter: "Chapter 838",
    href: "/statutes/ORS%20838.005",
    status: "active",
    semanticTypes: ["definition"],
    sourceBacked: true,
  }
