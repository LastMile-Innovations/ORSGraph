...
use crate::voyage::{estimate_tokens, model_config, VoyageClient, VOYAGE_4_LARGE};
...
pub const EMBEDDING_TARGETS: &[EmbeddingTargetSpec] = &[
    ...
    EmbeddingTargetSpec {
        ...
        input_expr: "'Oregon Revised Statutes. ' + toString($edition_year) + ' Edition.\\nCitation: ' + coalesce(n.display_citation, n.citation, '') + '\\nParent statute: ' + coalesce(n.citation, '') + '\\nProvision type: ' + coalesce(n.provision_type, '') + '\\nStatus: active\\n\\nProvision text:\\n' + coalesce(n.text, '')",
    },
    EmbeddingTargetSpec {
    ...
    EmbeddingTargetSpec { label: "Obligation", id_property: "obligation_id", profile: &LEGAL_OBLIGATION_PRIMARY, phase: EmbeddingPhase::Semantic, smoke_limit: 25, where_clause: "n.text IS NOT NULL AND n.text <> ''", input_expr: "'Oregon legal obligation.\\nSource: ' + coalesce(p.display_citation, n.source_provision_id, '') + '\\nActor: ' + coalesce(n.actor_text, '') + '\\nAction: ' + coalesce(n.action_text, '') + '\\nCondition: ' + coalesce(n.condition_text, '') + '\\n\\nText:\\n' + coalesce(n.text, '')" },
    EmbeddingTargetSpec { label: "Exception", id_property: "exception_id", profile: &LEGAL_EXCEPTION_PRIMARY, phase: EmbeddingPhase::Semantic, smoke_limit: 0, where_clause: "n.text IS NOT NULL AND n.text <> ''", input_expr: "'Oregon legal exception.\\nSource: ' + coalesce(p.display_citation, n.source_provision_id, '') + '\\nTrigger: ' + coalesce(n.trigger_phrase, '') + '\\nType: ' + coalesce(n.exception_type, '') + '\\n\\nText:\\n' + coalesce(n.text, '')" },
    EmbeddingTargetSpec { label: "Deadline", id_property: "deadline_id", profile: &LEGAL_DEADLINE_PRIMARY, phase: EmbeddingPhase::Semantic, smoke_limit: 25, where_clause: "n.text IS NOT NULL AND n.text <> ''", input_expr: "'Oregon legal deadline.\\nSource: ' + coalesce(p.display_citation, n.source_provision_id, '') + '\\nDeadline: ' + coalesce(n.duration, n.date_text, '') + '\\nTrigger: ' + coalesce(n.trigger_event, '') + '\\nActor: ' + coalesce(n.actor, '') + '\\nRequired action: ' + coalesce(n.action_required, '') + '\\n\\nText:\\n' + coalesce(n.text, '')" },
    EmbeddingTargetSpec { label: "Penalty", id_property: "penalty_id", profile: &LEGAL_PENALTY_PRIMARY, phase: EmbeddingPhase::Semantic, smoke_limit: 25, where_clause: "n.text IS NOT NULL AND n.text <> ''", input_expr: "'Oregon legal penalty.\\nSource: ' + coalesce(p.display_citation, n.source_provision_id, '') + '\\nPenalty type: ' + coalesce(n.penalty_type, '') + '\\nAmount/class: ' + coalesce(n.amount, n.civil_penalty_amount, n.criminal_class, '') + '\\nTarget conduct: ' + coalesce(n.target_conduct, n.condition, '') + '\\n\\nText:\\n' + coalesce(n.text, '')" },
    EmbeddingTargetSpec { label: "Remedy", id_property: "remedy_id", profile: &LEGAL_REMEDY_PRIMARY, phase: EmbeddingPhase::Semantic, smoke_limit: 0, where_clause: "n.text IS NOT NULL AND n.text <> ''", input_expr: "'Oregon legal remedy.\\nSource: ' + coalesce(p.display_citation, n.source_provision_id, '') + '\\nRemedy type: ' + coalesce(n.remedy_type, '') + '\\nAvailable to: ' + coalesce(n.available_to, '') + '\\nAvailable against: ' + coalesce(n.available_against, '') + '\\n\\nText:\\n' + coalesce(n.text, '')" },
    EmbeddingTargetSpec { label: "Definition", id_property: "definition_id", profile: &LEGAL_DEFINITION_PRIMARY, phase: EmbeddingPhase::DefinitionsHistory, smoke_limit: 25, where_clause: "n.definition_text IS NOT NULL AND n.definition_text <> ''", input_expr: "'Oregon legal definition.\\nTerm: ' + coalesce(n.term, '') + '\\nScope: ' + coalesce(n.scope_type, '') + ' ' + coalesce(n.scope_citation, '') + '\\nDefined in: ' + coalesce(p.display_citation, n.source_provision_id, '') + '\\n\\nDefinition:\\n' + coalesce(n.definition_text, '')" },
    EmbeddingTargetSpec { label: "DefinedTerm", id_property: "defined_term_id", profile: &LEGAL_DEFINED_TERM_PRIMARY, phase: EmbeddingPhase::DefinitionsHistory, smoke_limit: 0, where_clause: "n.term IS NOT NULL AND n.term <> ''", input_expr: "'Oregon defined legal term.\\nTerm: ' + coalesce(n.term, '') + '\\nNormalized term: ' + coalesce(n.normalized_term, '') + '\\nAuthority family: ' + coalesce(n.authority_family, '')" },
    EmbeddingTargetSpec { label: "DefinitionScope", id_property: "definition_scope_id", profile: &LEGAL_DEFINITION_SCOPE_PRIMARY, phase: EmbeddingPhase::DefinitionsHistory, smoke_limit: 0, where_clause: "n.scope_type IS NOT NULL AND n.scope_type <> ''", input_expr: "'Oregon legal definition scope.\\nScope type: ' + coalesce(n.scope_type, '') + '\\nScope citation: ' + coalesce(n.scope_citation, '') + '\\nTarget chapter: ' + coalesce(n.target_chapter_id, '') + '\\nTarget range: ' + coalesce(n.target_range_start, '') + ' ' + coalesce(n.target_range_end, '')" },
    EmbeddingTargetSpec { label: "SourceNote", id_property: "source_note_id", profile: &LEGAL_SOURCE_NOTE_PRIMARY, phase: EmbeddingPhase::DefinitionsHistory, smoke_limit: 25, where_clause: "n.text IS NOT NULL AND n.text <> ''", input_expr: "'Oregon legal history/currentness note.\\nCitation: ' + coalesce(n.citation, '') + '\\nType: ' + coalesce(n.note_type, '') + '\\nSession law: \\n\\nText:\\n' + coalesce(n.text, '')" },
    EmbeddingTargetSpec { label: "StatusEvent", id_property: "status_event_id", profile: &LEGAL_STATUS_EVENT_PRIMARY, phase: EmbeddingPhase::DefinitionsHistory, smoke_limit: 0, where_clause: "coalesce(n.status_text, n.trigger_text, n.status_type) IS NOT NULL", input_expr: "'Oregon legal status/currentness event.\\nCitation: ' + coalesce(n.canonical_id, '') + '\\nType: ' + coalesce(n.status_type, n.effect_type, '') + '\\nSession law: ' + coalesce(n.session_law_ref, '') + '\\n\\nText:\\n' + coalesce(n.status_text, n.trigger_text, '')" },
    EmbeddingTargetSpec { label: "TemporalEffect", id_property: "temporal_effect_id", profile: &LEGAL_TEMPORAL_EFFECT_PRIMARY, phase: EmbeddingPhase::DefinitionsHistory, smoke_limit: 10, where_clause: "coalesce(n.trigger_text, n.effect_type) IS NOT NULL", input_expr: "'Oregon legal history/currentness note.\\nCitation: ' + coalesce(n.canonical_id, '') + '\\nType: ' + coalesce(n.effect_type, '') + '\\nSession law: ' + coalesce(n.session_law_ref, '') + '\\n\\nText:\\n' + coalesce(n.trigger_text, '')" },
    EmbeddingTargetSpec { label: "LineageEvent", id_property: "lineage_event_id", profile: &LEGAL_LINEAGE_EVENT_PRIMARY, phase: EmbeddingPhase::DefinitionsHistory, smoke_limit: 0, where_clause: "n.raw_text IS NOT NULL AND n.raw_text <> ''", input_expr: "'Oregon legal lineage event.\\nCurrent citation: ' + coalesce(n.current_canonical_id, '') + '\\nType: ' + coalesce(n.lineage_type, '') + '\\nYear: ' + toString(coalesce(n.year, '')) + '\\n\\nText:\\n' + coalesce(n.raw_text, '')" },
    EmbeddingTargetSpec { label: "Amendment", id_property: "amendment_id", profile: &LEGAL_AMENDMENT_PRIMARY, phase: EmbeddingPhase::DefinitionsHistory, smoke_limit: 0, where_clause: "n.text IS NOT NULL AND n.text <> ''", input_expr: "'Oregon legal amendment.\\nCitation: ' + coalesce(n.canonical_id, n.affected_canonical_id, '') + '\\nType: ' + coalesce(n.amendment_type, '') + '\\nSession law: ' + coalesce(n.session_law_citation, '') + '\\nEffective date: ' + coalesce(n.effective_date, '') + '\\n\\nText:\\n' + coalesce(n.text, '')" },
    EmbeddingTargetSpec { label: "SessionLaw", id_property: "session_law_id", profile: &LEGAL_SESSION_LAW_PRIMARY, phase: EmbeddingPhase::DefinitionsHistory, smoke_limit: 10, where_clause: "coalesce(n.text, n.raw_text, n.citation) IS NOT NULL", input_expr: "'Oregon session law.\\nCitation: ' + coalesce(n.citation, '') + '\\nYear: ' + toString(coalesce(n.year, '')) + '\\nChapter: ' + coalesce(n.chapter, '') + '\\nSection: ' + coalesce(n.section, '') + '\\nBill: ' + coalesce(n.bill_number, '') + '\\nEffective date: ' + coalesce(n.effective_date, '') + '\\n\\nText:\\n' + coalesce(n.text, n.raw_text, '')" },
    EmbeddingTargetSpec { label: "RequiredNotice", id_property: "required_notice_id", profile: &LEGAL_REQUIRED_NOTICE_PRIMARY, phase: EmbeddingPhase::Specialized, smoke_limit: 10, where_clause: "n.text IS NOT NULL AND n.text <> ''", input_expr: "'Oregon required legal notice.\\nSource: ' + coalesce(p.display_citation, n.source_provision_id, '') + '\\nNotice type: ' + coalesce(n.notice_type, '') + '\\nSender: ' + coalesce(n.required_sender, '') + '\\nRecipient: ' + coalesce(n.required_recipient, '') + '\\nTrigger: ' + coalesce(n.trigger_event, '') + '\\n\\nText:\\n' + coalesce(n.text, '')" },
    EmbeddingTargetSpec { label: "FormText", id_property: "form_text_id", profile: &LEGAL_FORM_TEXT_PRIMARY, phase: EmbeddingPhase::Specialized, smoke_limit: 10, where_clause: "n.text IS NOT NULL AND n.text <> ''", input_expr: "'Oregon statutory form text.\\nSource: ' + coalesce(p.display_citation, n.source_provision_id, '') + '\\nForm type: ' + coalesce(n.form_type, '') + '\\n\\nText:\\n' + coalesce(n.text, '')" },
    EmbeddingTargetSpec { label: "MoneyAmount", id_property: "money_amount_id", profile: &LEGAL_MONEY_AMOUNT_PRIMARY, phase: EmbeddingPhase::Specialized, smoke_limit: 0, where_clause: "n.amount_text IS NOT NULL AND n.amount_text <> ''", input_expr: "'Oregon legal money amount.\\nSource: ' + coalesce(p.display_citation, n.source_provision_id, '') + '\\nAmount: ' + coalesce(n.amount_text, '') + '\\nType: ' + coalesce(n.amount_type, '')" },
    EmbeddingTargetSpec { label: "TaxRule", id_property: "tax_rule_id", profile: &LEGAL_TAX_RULE_PRIMARY, phase: EmbeddingPhase::Specialized, smoke_limit: 0, where_clause: "coalesce(n.tax_type, n.rate_text, n.base, n.cap) IS NOT NULL", input_expr: "'Oregon tax rule.\\nSource: ' + coalesce(p.display_citation, n.source_provision_id, '') + '\\nTax type: ' + coalesce(n.tax_type, '') + '\\nRate: ' + coalesce(n.rate_text, '') + '\\nBase: ' + coalesce(n.base, '') + '\\nCap: ' + coalesce(n.cap, '') + '\\nRecipient: ' + coalesce(n.recipient, '') + '\\nFund: ' + coalesce(n.fund_name, '')" },
    EmbeddingTargetSpec { label: "RateLimit", id_property: "rate_limit_id", profile: &LEGAL_RATE_LIMIT_PRIMARY, phase: EmbeddingPhase::Specialized, smoke_limit: 0, where_clause: "coalesce(n.rate_type, n.amount_text, n.cap_text) IS NOT NULL", input_expr: "'Oregon legal rate limit.\\nSource: ' + coalesce(p.display_citation, n.source_provision_id, '') + '\\nRate type: ' + coalesce(n.rate_type, '') + '\\nPercent: ' + toString(coalesce(n.percent_value, '')) + '\\nAmount: ' + coalesce(n.amount_text, '') + '\\nCap: ' + coalesce(n.cap_text, '')" },
    EmbeddingTargetSpec { label: "LegalActor", id_property: "actor_id", profile: &LEGAL_ACTOR_PRIMARY, phase: EmbeddingPhase::Specialized, smoke_limit: 0, where_clause: "n.name IS NOT NULL AND n.name <> ''", input_expr: "'Oregon legal actor.\\nName: ' + coalesce(n.name, '') + '\\nNormalized name: ' + coalesce(n.normalized_name, '') + '\\nActor type: ' + coalesce(n.actor_type, '')" },
    EmbeddingTargetSpec { label: "LegalAction", id_property: "action_id", profile: &LEGAL_ACTION_PRIMARY, phase: EmbeddingPhase::Specialized, smoke_limit: 0, where_clause: "coalesce(n.normalized_action, n.verb) IS NOT NULL", input_expr: "'Oregon legal action.\\nVerb: ' + coalesce(n.verb, '') + '\\nObject: ' + coalesce(n.object, '') + '\\nAction: ' + coalesce(n.normalized_action, '')" },
];
