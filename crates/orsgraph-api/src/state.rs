...
impl AppState {
    pub async fn new(config: ApiConfig) -> anyhow::Result<Self> {
        ...
        let casebuilder_service = Arc::new(CaseBuilderService::new(CaseBuilderServiceConfig {
            ...
            api_upload_max_bytes: config.casebuilder_api_upload_max_bytes,
            direct_upload_max_bytes: config.casebuilder_direct_upload_max_bytes,
            single_upload_max_bytes: config.casebuilder_single_upload_max_bytes,
            multipart_part_bytes: config.casebuilder_multipart_part_bytes,
            multipart_session_ttl_seconds: config.casebuilder_multipart_session_ttl_seconds,
