...
pub struct AdminPerformanceSummary {
    ...
    pub hotset_object_count: usize,
    pub hotset_bytes: u64,
    pub hotset_manifest_path: Option<String>,
    pub r2_hit_ratio: Option<f64>,
    pub railway_fallback_count: Option<u64>,
    pub cache_hit_ratio: Option<f64>,
    pub edge_metrics_source: String,
