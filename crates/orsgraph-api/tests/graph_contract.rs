...
fn casebuilder_service_sources() -> String {
    [
        ...
        include_str!("../src/services/casebuilder/markdown_graph.rs"),
        include_str!("../src/services/casebuilder/matters.rs"),
        include_str!("../src/services/casebuilder/repository.rs"),
        include_str!("../src/services/casebuilder/settings.rs"),
...
fn casebuilder_constraints_cover_core_graph_nodes() {
    ...
    for expected in [
        ...
        "casebuilder_user_settings_id",
        "casebuilder_user_settings_subject",
        "casebuilder_matter_settings_matter",
        "casebuilder_matter_settings_owner",
        ...
        "casebuilder_case_entity_matter",
        "casebuilder_search_index_record_document",
        "casebuilder_extraction_artifact_manifest_document",
        "casebuilder_markdown_ast_document_document",
        "casebuilder_markdown_ast_node_document",
        "casebuilder_markdown_ast_node_kind",
        ...
        "casebuilder_markdown_ast_node_fulltext",
...
fn document_workspace_contract_is_oss_only_and_casebuilder_native() {
    ...
    for expected in [
        ...
        "normalizeMarkdownAstDocument",
        "normalizeMarkdownAstNode",
        "normalizeCaseEntity",
...
fn casebuilder_indexing_data_model_and_storage_are_object_backed() {
    ...
    for expected in [
        ...
        "manifest.json",
        "structure_map",
        "extraction_manifest_structure_map",
        "casebuilder_indexer",
        "merge_index_run",
        "merge_page",
        "merge_text_chunk",
...
fn casebuilder_provenance_dtos_serialize_with_matter_safe_ids() {
    ...
    let text_chunk = TextChunk {
        ...
        structure_path: Some("Facts".to_string()),
        markdown_ast_node_ids: vec!["markdown-node:doc_opaque:abc".to_string()],
        byte_start: Some(0),
        byte_end: Some(10),
        char_start: Some(0),
        char_end: Some(10),
    ...
    let entity_mention = EntityMention {
        ...
        text_chunk_id: Some(text_chunk.text_chunk_id.clone()),
        source_span_id: Some(span.source_span_id.clone()),
        entity_id: Some("case-entity:matter_test:acme".to_string()),
        markdown_ast_node_ids: vec!["markdown-node:doc_opaque:abc".to_string()],
